 ...
 * 
 * Note: This file contains utility functions that should be called from API routes.
 * Each function initializes its own JamAI client to support multiple projects:
 * - Ingredient Guard: Uses JAMAI_API_KEY + proj_045275d84595590cb2eeb709
 * - IHCS Auto-Architect: Uses NEXT_PUBLIC_JAMAI_PERSONAL_ACCESS_TOKEN + NEXT_PUBLIC_JAMAI_PROJECT_ID
 */

import JamAI from 'jamaibase'

// Helper function to create JamAI client for Ingredient Guard
function getIngredientGuardClient() {
  return new JamAI({
