...
// Translations remain at bottom for backward compatibility
...
function RiskBadge({ level, language, text }: { level: string; language: string; text: any }) {
  return null // Kept for backward compatibility but not used in chat interface
}

// Keep old sections but hidden - remove everything below
const OldContent = () => {
  return (
    <div style={{ display: 'none' }}>
      {/* Old upload section code hidden */}
      {activeTab === 'upload' && (
