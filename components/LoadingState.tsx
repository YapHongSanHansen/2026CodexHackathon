...
export default function LoadingState({ message, submessage }: LoadingStateProps) {
  return (
    <div className="min-h-screen bg-[#FBFBFA] flex flex-col items-center justify-center p-4">
      <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#173127] to-[#3D5A4E] flex items-center justify-center mb-6">
        <Loader2 className="w-8 h-8 text-[#C5E86C] animate-spin" />
      </div>
      <p className="text-[#173127] font-semibold text-center text-lg">{message}</p>
      {submessage && (
